...
fun main() {
    ...
    val plotFirst = DrawPlot.createPlotThreadsTimes(SortAndDraw.getDataForPlotThreadsMicroseconds(maxAmountOfThreads, amountOfElements))
    ...
    println("График можно посмотреть в открывшемся браузере.")
    val plotSecond = DrawPlot.createPlotElementsTimes(SortAndDraw.getDataForPlotElementsMicroseconds(amountOfThreads, maxAmountOfElements))
